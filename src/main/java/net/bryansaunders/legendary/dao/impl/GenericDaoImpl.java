...
import net.bryansaunders.legendary.dao.GenericDao;
import net.bryansaunders.legendary.model.LegendaryEntity;
 ...
 */
@Stateless
public class GenericDaoImpl<T extends LegendaryEntity> implements GenericDao<T> {
